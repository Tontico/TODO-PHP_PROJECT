...
class FormController extends AbstractController{
     ...
     public function constructAbonneForm()
    {

        $form="<form action='http://localhost/phpobjet/phpTestComposer/index.php?controller=AbonneController&method=createAbonne' method='POST'>
